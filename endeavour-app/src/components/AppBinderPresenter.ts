...
import type { AsyncPageStatus, Binder, BinderStatus, BinderStore } from '@/stores/binder-store';
...
export default defineComponent({
  ...
  props: {
    value: {
      type: Object as PropType<Binder<unknown> | BinderStore<unknown[], unknown>>,
      required: true,
    },
  },
  setup(props, { slots }) {
